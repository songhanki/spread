    ...
    render(){
        return(
            <div className="app-footer">
                <span className="footer-text">© 2023 GrapeCity, inc. All Rights Reserved. All product and company names herein may be trademarks of their respective owners.</span>
            </div>
        )
    }
}
